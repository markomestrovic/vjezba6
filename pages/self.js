...
const Self = () => {
                ...
                <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
                    <div className="max-w-md">
                        ...
                        <p className="text-2xl md:text-3xl font-light leading-normal">
                            Sorry we couldn&#39;t let you in.{' '}
                        </p>
                        <p className="mb-8">
                            But dont worry, you can find plenty of other things on
                            our homepage. Or you can try logging in 🙂
                        </p>

                        <Link href="/login" passHref>
                            <button className="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-hci-lila active:bg-blue-600 hover:bg-blue-700">
                                Back to login
                            </button>
                        </Link>
                    </div>
                    ...
                    >
                        ...
                        <path
                            className="cls-3"
                            d="m959 1447-.09 82.82c0 6.19 6.66 11.22 14.88 11.23h.3c8.22 0 14.9-5 14.9-11.2l.09-81.9c0-.53-6.95-1-15.39-1H959M1749 1447l-.09 82.82c0 6.19 6.66 11.22 14.88 11.23h.3c8.22 0 14.9-5 14.9-11.2l.09-81.9c0-.53-7-1-15.39-1H1749"
                        />
                        <path
                            d="M1825.5 1426.5H755.25a10.75 10.75 0 0 0-10.75 10.75 10.75 10.75 0 0 0 10.75 10.75H1815a10.75 10.75 0 0 0 10.74-11l-.24-10.5"
                            style={{
                                fill: '#dcdbda',
                                strokeMiterlimit: 10,
                                strokeWidth: 3,
                        ...
                        <path
                            className="cls-7"
                            d="m1530.83 851.27 119.81-98a13.73 13.73 0 0 1 22.29 8.61c3.24 22.58 4.13 45.46 4.35 81S1665 911 1656.5 964.5a284.8 284.8 0 0 0-125.67-113.23Z"
                        />
                        <path
                            className="cls-8"
                        ...
                        <path
                            className="cls-7"
                            d="M1379.5 855.5c-43.86-27.19-89.35-56.1-133.21-83.29-9.07-5.62-23.66 1.62-23.79 12.29-.27 22.81-4 48.1 3 83 3.77 18.84 5.45 28.58 9.26 41.5a315.06 315.06 0 0 0 19.74 50.5 199 199 0 0 1 18-29c5.75-7.71 26.56-34.42 64-56a221.93 221.93 0 0 1 43-19Z"
                        />
                        <path
                            d="M1222.5 782.5s75.38 65.94 84.71 83.21c.55 1 2.89 5.62 1.16 7.71-3.3 4-17.41-6.08-23.87-.92a6.77 6.77 0 0 0-1.62 1.92 8 8 0 0 0 .75 8.68c2.16 2.87 5 7.47 4.73 11.84a6.33 6.33 0 0 1-1.15 3.63c-1.93 2.36-5.52 2.38-6.51 2.38-6.55 0-10.09-6.31-10.25-6.6a4.65 4.65 0 0 0-6 .13 3.51 3.51 0 0 0-.94 2 8.85 8.85 0 0 0 .82 5.06c2.17 4.39-.37 18.55-1.85 24.93a93.65 93.65 0 0 1-11 27c-9-19.66-21.15-51-27-89a326.82 326.82 0 0 1-3.49-62.74c.38-7.83 1.01-14.43 1.51-19.23Z"
                            style={{
                                fill: '#f3d2c9',
                                strokeWidth: 3,
                                strokeLinecap: 'round',
                        ...
                        <path
                            className="cls-10"
                            d="m1445.26 997.13 10.24 1.37 9.39-1.34a2.14 2.14 0 0 1 2.11 3.27l-9.09 14.28a3 3 0 0 1-4.94.08l-9.77-14.33a2.15 2.15 0 0 1 2.06-3.33Z"
                        />
                        <path
                            className="cls-13"
                        ...
                        <path
                            className="cls-14"
                            d="M1664.5 1001.5 1735 980M1667 1017l66.5 10.5M1244 1017l-60.5 13.5M1246.5 1000.5 1180 990"
                        />
                        <path
                            className="cls-15"
                        ...
                        <path
                            className="cls-15"
                            d="M823.54 819.3c-17.76-23.9-59.56-97.14-83.92-120.77a597.13 597.13 0 0 0-166.5-113.78l-22.31 8.44a635.18 635.18 0 0 1 182.77 131.33c17.7 18.29 54.44 85.77 68.42 104Z"
                        />
                        <path
                            className="cls-7"
                            d="m1479.5 1367.5 34 76a192.85 192.85 0 0 1-51-1s-29.19-3.39-48.59-18c-13.48-10.12-14.12-17.25-14.29-19.38-.78-9.74 5.64-16.63 8.13-19l.75-.68c9-7.86 25-8.93 26-9 10.24-.63 24.39-3.28 45-8.94Z"
                        />
                        <path
                            d="m1173.28 1285.23 30.22-89.73a156.61 156.61 0 0 0-60 11 149.83 149.83 0 0 0-38 23c-1 .85-15 12.88-15.5 24.47v1.26c.23 9.77 7.33 16 10.06 18l.82.6c8.37 5.92 18.58 5.26 33.63 5.63 8.49.21 12.73.32 18 1a113.17 113.17 0 0 1 20.77 4.77Z"
                            style={{
                                fill: '#333',
                                stroke: '#191818',
                                strokeWidth: 3,
                        ...
                        <path
                            className="cls-17"
                            d="m292.3 344.49-28.05-15.3a40.34 40.34 0 0 1-20.8-39.64l2.35-22.21a61.8 61.8 0 0 1 26.57-44.52 29.52 29.52 0 0 1 29.48-2.22 82.16 82.16 0 0 0 8.28 3.32 234.66 234.66 0 0 1 86.78 54.37l-43.47 78.83Z"
                        />
                        <path
                            className="cls-17"
                            d="m318.73 318-.69.05a40.94 40.94 0 0 0-37 32l-2.68 12.12a53.57 53.57 0 0 0 33.25 61.63l82.49 31.4 12.7-90.2-57-38.69a48.91 48.91 0 0 0-31.07-8.31ZM465 262.82l-32.13-42.59A53.66 53.66 0 0 0 379 200l-10.53 2.21A31.57 31.57 0 0 0 348.89 251l27 38.3 84.61 30.61Z"
                        />
                        <circle
                            className="cls-9"
                            cx={395.47}
    ...
    return (
        <HeaderFooterLayout>
            <main className="flex-col items-center content-center text-center">
                <section>
                    <p className="text-3xl font-normal leading-normal mt-0 mb-2 text-pink-800">
                        This is the Self page.
                    </p>
                </section>
                <section>
                    <h2 className="text-xl font-semibold leading-normal mt-0 mb-2 text-hci-lila">
                        Current User
                    </h2>
                    <p className="text-lg font-semibold leading-normal mt-0 mb-2 text-hci-lila">
                        Name:
                    </p>
                    <p className="text-lg font-normal leading-normal mt-0 mb-2 text-hci-lila-dark">
                        {currentUser.name}
                    </p>
                    <p className="text-lg font-semibold leading-normal mt-0 mb-2 text-hci-lila">
                        Email:
